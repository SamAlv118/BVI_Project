...
import BVI_Spectroscopy_UI

spectype = BVI_Spectroscopy_UI.stype[0]

if spectype == "Emission":
    pass

if spectype == "Absorption":
    exclusions = BVI_Spectroscopy_UI.exclusions.copy()
    print(exclusions)
